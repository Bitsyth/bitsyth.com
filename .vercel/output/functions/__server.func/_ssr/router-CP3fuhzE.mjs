...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CP3fuhzE.js
...
var styles_default = "/assets/styles-BdH34Q6B.css";
var APP_NAME = "Bitsyth";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Bitsyth — Life is a Game and Eternal Rhythm."
			},
			{
...
var $$splitComponentImporter$1 = () => import("./routes-DQXSjQ1C.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-yE7AU3lh.mjs");
